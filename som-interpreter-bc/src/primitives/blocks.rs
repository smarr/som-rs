...
pub mod block1 {
    ...
    fn value(interpreter: &mut Interpreter, universe: &mut UniverseBC) {
        ...
        interpreter.push_block_frame(block, vec![Value::Block(block)], universe.allocator.as_mut());
...
pub mod block2 {
    ...
    fn value(interpreter: &mut Interpreter, universe: &mut UniverseBC) {
        ...
        interpreter.push_block_frame(block, vec![Value::Block(block), argument], universe.allocator.as_mut());
...
pub mod block3 {
    ...
    fn value_with(interpreter: &mut Interpreter, universe: &mut UniverseBC) {
        ...
        interpreter.push_block_frame(block, vec![Value::Block(block), argument1, argument2], universe.allocator.as_mut());
