...
impl DownToDoNode {
    fn do_int_loop(start_int: i32, end_int: i32, body_block: &Gc<Block>, universe: &mut Universe, value_stack: &mut GlobalValueStack) -> Return {
